...
{
    public partial class CashApp : Form
    {
        public string cid;
            ...
            foreach (DataGridViewRow dr in dgvProduct.Rows)
            {
                ...
                if (checkbox)
                {
                    try
                    {
                        ...
                        cmd.Parameters.AddWithValue("@transno", app.lbTransaction.Text);
